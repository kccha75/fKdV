...
function [v,lambda,gamma]=pseudoarclength_test(v,lambda,gamma,dv,dlambda,dgamma,ds,steps,... 
...
%         cellz1{1}=real(cellz1{1});
%         cellz2{1}=real(cellz2{1});
%         cellz3{1}=real(cellz3{1});
